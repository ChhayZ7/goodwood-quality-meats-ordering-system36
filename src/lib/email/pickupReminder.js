...
// Pickup reminder email — sent the day before a customer's scheduled pickup
// via the pg_cron job at /api/cron/pickup-reminder.
...
export function pickupReminderHtml({ customer, order, invoiceNumber, pickupDate }) {
  const itemLines = (order.order_items ?? []).map(item => {
    ...
    return `
      <tr>
        <td style="padding: 10px 0; border-bottom: 1px solid #F0EAD8;
            ...
            <table width="600" cellpadding="0" cellspacing="0"
              ...
              <tr>
                <td style="padding: 40px 40px 24px;">
                  ...
                  <!-- Order summary box -->
                  <table width="100%" cellpadding="0" cellspacing="0"
                    style="background: #FDF8F0; border-radius: 8px;
                           border: 1px solid #E8D48A; margin-bottom: 28px;">
                    <tr>
                      <td style="padding: 20px 24px;">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="font-size: 13px; color: #717182; padding-bottom: 6px;">
                              Order number
                            </td>
                          ...
                          <tr>
                            ...
                            <td style="font-size: 14px; color: #7B1A1A; font-weight: bold;
                                       text-align: right;">
                              ${balanceFormatted}
                            </td>
                          </tr>
                  ...
                  <!-- What to bring box -->
                  <table width="100%" cellpadding="0" cellspacing="0"
                    style="background: #FEF9E7; border-radius: 8px;
                           border: 1px solid #FAC775; margin-bottom: 28px;">
                    <tr>
                      <td style="padding: 18px 24px;">
                        ...
                        <p style="font-size: 13px; color: #854F0B; line-height: 1.7; margin: 0;">
                          ...
                          <strong>${balanceFormatted}</strong><br/>
...
/**
 * Sends the pickup reminder email to a single customer.
 * The cron route handles order querying and reminder_sent flagging;
 * this function only concerns itself with sending.
 *
 * @param {object} params
