...
import { FiMapPin, FiPhone, FiMail, FiClock } from "react-icons/fi";  // Importing icons from the react-icons library
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          <div className="pl-6">
            ...
            <div className="flex items-start gap-4 mb-8">
              ...
              <div>
                <h3 style={{ color: "#000" }} className="text-2xl mb-2">
                  <b>Visit Our Store</b>
                </h3>
                <p style={{ color: "#555" }} className="text-2xl">
                  121 Goodwood Road
                </p>
                <p style={{ color: "#555" }} className="text-2xl">
                  Goodwood, SA 5034
          ...
          <div className="flex justify-center md:justify-end">
            ...
            {/* This anchor tag makes the map image clickable. When clicked, it opens Google Maps in a new browser tab */}
            <a
