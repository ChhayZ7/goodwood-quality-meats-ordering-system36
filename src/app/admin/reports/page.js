...
function TopItemsChart({ items }) {
  ...
  const revenueTicks = [0, 1, 2, 3].map(i =>
    Math.round((maxRevenue / 3) * i)
  )
  ...
  return (
    <div style={pageSt}>
      <div style={containerSt}>
        ...
        {/* Gold divider */}
        <div style={{ height: '2px', background: 'linear-gradient(90deg, #C9A84C, transparent)', borderRadius: '1px' ,marginBottom: '32px',}} />
