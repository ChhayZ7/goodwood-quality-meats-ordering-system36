        ...
        <main style={{ flex: 1, padding: '48px 40px 80px' }}>
          <div style={{ maxWidth: '1180px', margin: '0 auto' }}>
            ...
            >
              ...
              >
                The {isAdmin ? 'admin' : 'staff'} account for{' '}
                <strong>
                  {firstName} {lastName}
                </strong>{' '}
                has been created. Share the temporary password with them so they
                can log in.
              </p>
              ...
              >
                <button
                  ...
                  onMouseEnter={e =>
                    (e.currentTarget.style.background = '#5C1212')
                  }
                  onMouseLeave={e =>
          ...
          >
            <div style={{ marginBottom: '16px', marginTop: '3px' }}>
              ...
              {isAdmin && (
                ...
                >
                  Admin accounts have full access to all settings, staff
            ...
            >
              <div>
                ...
                <input
                  ...
                  style={{
                    ...inputSt,
                    borderColor: errors.firstName ? '#B91C1C' : COLOR.border,
                  }}
                />
              ...
              <div>
                ...
                <input
                  ...
                  style={{
                    ...inputSt,
                    borderColor: errors.lastName ? '#B91C1C' : COLOR.border,
                  }}
                />
            ...
            <div style={{ marginBottom: '16px' }}>
              ...
              <input
                ...
                style={{
                  ...inputSt,
                  borderColor: errors.email ? '#B91C1C' : COLOR.border,
                }}
              />
            ...
            <div style={{ marginBottom: '8px' }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{
                    ...inputSt,
                    paddingRight: '44px',
                    borderColor: errors.password ? '#B91C1C' : COLOR.border,
                  }}
                />
              ...
              >
                Share this with the {isAdmin ? 'admin' : 'staff member'} - they
                can update it after logging in
              </p>
            </div>
            ...
            >
              <button
                ...
                onMouseEnter={e => {
                  if (!saving) e.currentTarget.style.background = '#5C1212'
                }}
                onMouseLeave={e => {
              ...
              >
                {saving
                  ? 'Creating…'
                  : `Create ${isAdmin ? 'Admin' : 'Staff'} Account`}
              </button>
