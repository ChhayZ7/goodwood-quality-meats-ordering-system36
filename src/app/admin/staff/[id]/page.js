  ...
  return (
    <div
      style={{
        ...
        animation: 'staffDetailPulse 1.4s ease-in-out infinite',
      }}
    />
  )
}
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <SkeletonBox width="70px" height={32} radius={8} />
            <SkeletonBox width="90px" height={30} radius={99} />
          </div>
        </div>
...
export default function EditStaffPage() {
  ...
  if (fetchError) {
    return (
      ...
      >
        <main style={{ flex: 1, padding: '48px 40px 80px' }}>
          <div style={{ maxWidth: '1180px', margin: '0 auto' }}>
            <button
              ...
              onMouseEnter={e => {
                e.currentTarget.style.color = '#5C1212'
              }}
              onMouseLeave={e => {
  ...
  const deleteMatch =
    deleteConfirm.trim().toLowerCase() === fullName.toLowerCase()
  ...
  return (
    ...
    >
      <main style={{ flex: 1, padding: '48px 40px 80px', overflowY: 'auto' }}>
        <div style={{ maxWidth: '1180px', margin: '0 auto' }}>
          <button
            onClick={() => router.push('/admin/staff')}
            style={{
            ...
            >
              <span
                style={{
                  ...
                  fontWeight: 700,
                  fontFamily: '"Lato", sans-serif',
                  background: isAdmin ? COLOR.red : COLOR.gold,
                  color: COLOR.white,
                }}
              >
                {isAdmin ? 'Admin' : 'Staff'}
              ...
              style={{
                ...
                color: toggling
                  ...
                  : member.is_active
                    ...
                    : '#166534',
                border: `1.5px solid ${
                  member.is_active ? COLOR.redBorder : '#BBF7D0'
                }`,
                transition: 'all .15s',
              }}
            >
          ...
          <SectionCard danger>
            ...
            >
              Permanently removes this account. This cannot be undone as the
              staff member will lose access immediately. Use deactivation
              instead if this is temporary for a short period of time.
            </p>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: '"Lato", sans-serif',
                      background:
                        !deleteMatch || deleting ? '#E5DCC8' : '#DC2626',
                      color:
                        !deleteMatch || deleting ? COLOR.muted : COLOR.white,
                      cursor:
                        !deleteMatch || deleting ? 'not-allowed' : 'pointer',
